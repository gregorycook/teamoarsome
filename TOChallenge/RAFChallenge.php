...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="style/rafstyle.css">
	...
	<body onload="new Accordian('basic-accordian',5,'header_highlight');">
		  <div id="logo">
			<img src="style/TObanner.png" alt="RAF Banner">
  		  </div>
				    			...
				    			echo '<div id="current-header" class="'.$divClass.'">Current Challenge</div>';
					    			echo '<div id="current-content">';
						      			echo '<div class="accordion_child">';
						      				echo '<a class="navlink" href="RAFChallenge.php">'.FormatChallenge($challenge).'</a>';
						      			echo '</div>';
							}
							elseif ($foundCurrent)
							{
								if ($sectionYear != $challenge->ChallengeYear())
								{
					    			...
					    			echo '<div id="section'.$sectionYear.'-content">';
						      			...
						      			echo '<div class="accordion_child">';
						      				echo '<a class="navlink" href="RAFChallenge.php?id='.$challenge->ChallengeId.'">'.FormatChallenge($challenge).'</a>';
						      			echo '</div>';
							}
						}
						echo '</div>';
		...
		<div id="entry">	
			...
			<form action="RAFChallenge.php" method="POST">
